...
$allowedExtensions = ['pdf', 'jpg', 'jpeg', 'png', 'gif', 'docx', 'doc', 'odt'];

if (in_array($fileExtension, $allowedExtensions)) {
    // Vérification du type de fichier (mime type) pour renforcer la sécurité
    $allowedMimeTypes = ['application/pdf', 'image/jpeg', 'image/png', 'image/gif', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.oasis.opendocument.text'];
